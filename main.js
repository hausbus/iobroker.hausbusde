...
function hwControllerReceivedRemoteObjects(sender, receiver, message, dataLength)
{
	...
	if (typeof moduleTypes[deviceId]=="undefined")
	{
      ...
      else if ((nrTaster==6 && nrLeds==6) || (nrTaster==12 && nrLeds==12)) moduleType=MODUL_ID_6_TASTER;
	...
	else moduleType = moduleTypes[deviceId];
...
function addIoBrokerStatesForInstance(deviceId, classId, instanceId)
{
   ...
   {
	  addStateIoBroker(TASTER_FKT_DISABLE_EVENTS_TIMEOUT, 'string', 'switch', deviceId, classId, instanceId, true, false, "timeout",CHANNEL_CONFIG);
   ...
   else if (classId == CLASS_ID_LED)
   {
	  ...
	  addStateIoBroker(LED_FKT_OFF_DELAY, 'string', 'switch', deviceId, classId, instanceId, true, false, "offDelay");
   ...
   else if (classId == CLASS_ID_LOGICAL_BUTTON)
   {
	  ...
	  addStateIoBroker(LOGICAL_BUTTON_ON_BRIGHTNESS_DURATION, 'string', 'switch', deviceId, classId, instanceId, true, false, "brightness");
...
function initModulesClassesInstances()
{
	...
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][17]="Taster 1";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][18]="Taster 2";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][19]="Taster 3";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][20]="Taster 4";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][21]="Taster 5";
    INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][22]="Taster 6";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][33]="Extern Taster 1";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][34]="Extern Taster 2";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][35]="Extern Taster 3";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][36]="Extern Taster 4";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TASTER][55]="Extern Taster 5";
	...
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][49]="Led 1";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][50]="Led 2";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][51]="Led 3";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][52]="Led 4";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][53]="Led 5";
    INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][54]="Led 6";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][65]="Extern Led 1";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][66]="Extern Led 2";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][67]="Extern Led 3";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][68]="Extern Led 4";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][69]="Extern Led 5";
    INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_LED][70]="Extern Led 6";
	...
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][1]="Temperatursensor 1";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][2]="Temperatursensor 2";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][3]="Temperatursensor 3";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][4]="Temperatursensor 4";
	INSTANCES[MODUL_ID_6_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][5]="Temperatursensor 5";
	...
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][17]="Taster 1";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][18]="Taster 2";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][21]="Taster 3";
    INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][22]="Taster 4";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][33]="Extern Taster 1";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][34]="Extern Taster 2";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][35]="Extern Taster 3";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][36]="Extern Taster 4";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TASTER][55]="Extern Taster 5";
	...
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][50]="Led 2";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][53]="Led 3";
    INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][54]="Led 4";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][65]="Extern Led 1";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][66]="Extern Led 2";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][67]="Extern Led 3";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][68]="Extern Led 4";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][69]="Extern Led 5";
    INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_LED][70]="Extern Led 6";
	...
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][1]="Temperatursensor 1";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][2]="Temperatursensor 2";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][3]="Temperatursensor 3";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][4]="Temperatursensor 4";
	INSTANCES[MODUL_ID_4_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][5]="Temperatursensor 5";
	...
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][19]="Taster 1";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][20]="Taster 2";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][33]="Extern Taster 1";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][34]="Extern Taster 2";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][35]="Extern Taster 3";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][36]="Extern Taster 4";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TASTER][55]="Extern Taster 5";
	...
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][51]="Led 1";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][52]="Led 2";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][65]="Extern Led 1";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][66]="Extern Led 2";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][67]="Extern Led 3";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][68]="Extern Led 4";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][69]="Extern Led 5";
    INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_LED][70]="Extern Led 6";
	...
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][1]="Temperatursensor 1";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][2]="Temperatursensor 2";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][3]="Temperatursensor 3";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][4]="Temperatursensor 4";
	INSTANCES[MODUL_ID_2_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][5]="Temperatursensor 5";
	...
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][19]="Taster 1";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][33]="Extern Taster 1";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][34]="Extern Taster 2";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][35]="Extern Taster 3";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][36]="Extern Taster 4";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TASTER][55]="Extern Taster 5";
	...
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][51]="Led 1";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][65]="Extern Led 1";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][66]="Extern Led 2";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][67]="Extern Led 3";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][68]="Extern Led 4";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][69]="Extern Led 5";
    INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_LED][70]="Extern Led 6";
	...
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][1]="Temperatursensor 1";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][2]="Temperatursensor 2";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][3]="Temperatursensor 3";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][4]="Temperatursensor 4";
	INSTANCES[MODUL_ID_1_TASTER]["*"][CLASS_ID_TEMPERATURSENSOR][5]="Temperatursensor 5";
	...
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][17]="Eingang 01";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][18]="Eingang 02";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][19]="Eingang 03";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][20]="Eingang 04";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][21]="Eingang 05";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][22]="Eingang 06";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][23]="Eingang 07";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][24]="Eingang 08";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][25]="Eingang 09";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][26]="Eingang 10";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][27]="Eingang 11";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_TASTER][28]="Eingang 12";

	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED]={};
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][49]="Ausgang 01";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][50]="Ausgang 02";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][51]="Ausgang 03";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][52]="Ausgang 04";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][53]="Ausgang 05";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][54]="Ausgang 06";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][65]="Ausgang 07";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][66]="Ausgang 08";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][67]="Ausgang 09";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][68]="Ausgang 10";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][69]="Ausgang 11";
	INSTANCES[MODUL_ID_24_UP_IO]["*"][CLASS_ID_LED][70]="Ausgang 12";
	...
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][1]="Dimmer 01";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][2]="Dimmer 02";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][3]="Dimmer 03";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][4]="Dimmer 04";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][5]="Dimmer 05";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][6]="Dimmer 06";
	INSTANCES[MODUL_ID_8_DIMMER]["*"][CLASS_ID_DIMMER][7]="Dimmer 07";
	...
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][1]="Dimmer 01";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][2]="Dimmer 02";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][3]="Dimmer 03";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][4]="Dimmer 04";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][5]="Dimmer 05";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][6]="Dimmer 06";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][7]="Dimmer 07";
	INSTANCES[MODUL_ID_8_DIMMER][FIRMWARE_ID_HBC][CLASS_ID_DIMMER][8]="Dimmer 08";
	...
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][49]="Ausgang 01";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][50]="Ausgang 02";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][51]="Ausgang 03";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][52]="Ausgang 04";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][53]="Ausgang 05";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][54]="Ausgang 06";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][55]="Ausgang 07";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][56]="Ausgang 08";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][97]="Ausgang 09";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][98]="Ausgang 10";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][99]="Ausgang 11";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][100]="Ausgang 12";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][101]="Ausgang 13";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][102]="Ausgang 14";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][103]="Ausgang 15";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_SCHALTER][104]="Ausgang 16";

	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER]={};
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][17]="Eingang 01";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][18]="Eingang 02";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][19]="Eingang 03";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][20]="Eingang 04";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][21]="Eingang 05";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][22]="Eingang 06";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][23]="Eingang 07";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][24]="Eingang 08";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][33]="Eingang 09";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][34]="Eingang 10";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][35]="Eingang 11";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][36]="Eingang 12";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][37]="Eingang 13";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][38]="Eingang 14";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][39]="Eingang 15";
	INSTANCES[MODUL_ID_32_IO]["*"][CLASS_ID_TASTER][40]="Eingang 16";
	...
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_TASTER][17]="Eingang 1";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_TASTER][18]="Eingang 2";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_TASTER][19]="Eingang 3";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_TASTER][20]="Eingang 4";

	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_LED]={};
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_LED][49]="Dimmer 1";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_LED][50]="Dimmer 2";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_LED][51]="Dimmer 3";
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_LED][52]="Dimmer 4";

	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_SCHALTER]={};
	INSTANCES[MODUL_ID_4_DIMMER]["*"][CLASS_ID_SCHALTER][210]="Rote Modul LED";
